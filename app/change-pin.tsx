  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <Ionicons name="keypad-outline" size={42} color="rgba(255,255,255,0.5)" />
        <Text style={styles.headline}>PIN Update</Text>
        <Text style={styles.text}>
          PIN change flow is enabled as a separate route and ready for secure PIN update logic.
        </Text>
      </View>
    </View>
  );
