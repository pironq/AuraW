...
// Mock wallets
const MOCK_WALLETS = [
  { id: '1', name: 'Main Wallet', address: '0x1a2B...9cDe', balance: '$4,218.63' },
  { id: '2', name: 'Trading', address: '0x3f4A...7bCc', balance: '$892.10' },
  { id: '3', name: 'Savings', address: '0x8d1E...2fAa', balance: '$12,450.00' },
];

const MOCK_TOKENS = [
  { symbol: 'ETH', name: 'Ethereum', network: 'Mainnet', balance: '1.4520', value: '$3,842.16', price: '$2,645.80', change: '+2.8%', positive: true },
...
const TOKEN_ICONS: Record<string, keyof typeof Ionicons.glyphMap> = {
  ETH: 'diamond-outline',
  USDT: 'cash-outline',
  USDC: 'ellipse-outline',
  ARB: 'triangle-outline',
  LINK: 'link-outline',
};
...
export default function HomeScreen() {
  ...
  // Dismiss search bar when keyboard hides and query is empty
  useEffect(() => {
  ...
  const totalBalance = '$4,218.63';
  const balanceChange = '+$127.40 (3.1%)';
        ...
        <Animated.View style={[styles.balanceCard, cardStyle]}>
          ...
          <View style={styles.balanceSection}>
            ...
            <View style={styles.changeRow}>
              ...
              <Text style={styles.balanceChange}>{balanceChange}</Text>
            </View>
          </View>
                ...
                >
                  <Pressable style={styles.tokenRow}>
                    <View style={styles.tokenIcon}>
                      <Ionicons
                        name={TOKEN_ICONS[token.symbol] || 'ellipse-outline'}
                        size={22}
                    ...
                    <View style={styles.tokenInfo}>
                      <View style={styles.tokenNameRow}>
                        ...
                        <View style={styles.networkBadge}>
                          <Text style={styles.networkText}>{token.network}</Text>
                        </View>
                      </View>
          ...
          <View style={styles.modalContent}>
            ...
            {MOCK_WALLETS.map(wallet => (
              ...
              >
                ...
                <Text style={styles.walletOptionBalance}>{wallet.balance}</Text>
              </Pressable>
            ))}
